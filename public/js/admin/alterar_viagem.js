    ...
    $("#btn-add").click(function (e) {
        ...
        if ($(veiculo).val() == "" || $(motorista).val() == ""){
            ...
            $("table tbody").append("<tr id='"+linha_gerar+"'>" +
                ...
                "</td>" +
                "<td>" +
                "<input type='text' class='form-control placa' value='"+placa+"' name='veiculos[]' id='' placeholder='Indetificação' data-nome='Placa || Indetificação do veiculo "+linha_gerar+"' readonly>" +
                "</td>" +
                "<td>" +
