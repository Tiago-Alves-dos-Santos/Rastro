...
<div class="container">
    <div class="row d-flex justify-content-center">
        <div class="col-md-8">
            <h1 style="margin-top: 80px; margin-bottom: 30px; text-align: center">Cadastro de clientes</h1>
            <form class="needs-validation" novalidate method="post" action="{{ route('user.create.cliente') }}">
                @csrf
                ...
                <div style="text-align: right; margin-top: 30px; margin-bottom: 45px">
                    <button class="btn btn-verde btn-block" type="submit">Cadastrar</button>
                </div>
            </form>
        </div>
    </div>
...
<script src="{{ asset('js/usuario/cadastrar_cliente.js') }}"></script>
</body>
</html>
